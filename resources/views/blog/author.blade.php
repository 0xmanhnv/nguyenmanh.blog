...
@section('css')
	<link rel="stylesheet" type="text/css" href="{{ asset('blog_nguyenmanh/css/author.css') }}">
@endsection
						            ...
						            <div class="timeline-entry-inner">
						                ...
						                <div class="timeline-label">
						                    <h2>
						                    	...
						                    	<p style="color: red;">
						                    		<a href="{{ route('blog.category', [$post->category->id, $post->category->slug]) }}">
...
@section('script')
	<script type="text/javascript" src="{{ asset('blog_nguyenmanh/js/author.js') }}"></script>
@endsection
